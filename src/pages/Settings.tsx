            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Get notified when items are expiring</p>
                </div>
                <Switch
                  id="expiryAlerts"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Weekly pantry summary and recommendations</p>
                </div>
                <Switch
                  id="weeklyReport"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="recipeRecommendations" className="text-base font-medium">
                    Recipe Recommendations
                  </Label>
                  <p className="text-sm text-gray-600">AI-powered recipe suggestions</p>
                </div>
                <Switch
