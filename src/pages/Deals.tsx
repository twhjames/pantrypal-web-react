...
const Deals = () => {
  ...
  const categories = ['all', 'dairy', 'fruits', 'vegetables', 'meat', 'bakery', 'beverages'];
  ...
  return (
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Expiring Deals 🛒</h1>
          <p className="text-gray-600 mt-2">Discover discounted groceries from partner retailers</p>
        </div>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-2 text-sm text-gray-600">
                        ...
                        <div>
                          <div className="font-medium">{deal.retailer.name}</div>
                          <div>{deal.retailer.location}</div>
                        </div>
                      </div>

                      <Button 
                        onClick={() => handleViewOffer(deal)}
