...
const Pantry = () => {
  ...
  const categories = ['all', 'dairy', 'fruits', 'vegetables', 'meat', 'grains', 'beverages', 'snacks', 'other'];
  ...
  const handleAddItem = async () => {
    try {
      ...
      setItemForm({ name: '', category: '', quantity: 1, purchaseDate: '', expiryDate: '' });
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      ...
      console.log('API Call: PUT /pantry/items/' + editingItem.id, itemForm);
    ...
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your grocery inventory and track expiry dates</p>
        </div>
